...
namespace Ciomag_Andreea_Museum.Migrations
{
    ...
    [Migration("20230113201023_Third")]
    partial class Third
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClientExhibition", b =>
                {
                    ...
                    b.HasKey("ClientsID", "ExhibitionsID");

                    b.HasIndex("ExhibitionsID");

                    b.ToTable("ClientExhibition");
                });
            ...
            modelBuilder.Entity("ClientExhibition", b =>
                {
                    b.HasOne("Ciomag_Andreea_Museum.Models.Client", null)
                        .WithMany()
                        .HasForeignKey("ClientsID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ciomag_Andreea_Museum.Models.Exhibition", null)
                        .WithMany()
